...
parser.add_argument("--algo", default="dca", type=str, choices=["higl", "hrac", "hiro", "aclg", "dca"])
...
parser.add_argument("--log_dir", default="/home/dca-hrl-good-version/logs", type=str)
...
parser.add_argument("--sigma", type=int, default=1e5)
parser.add_argument("--aux_rew_lambda", default=1e0, type=float)
